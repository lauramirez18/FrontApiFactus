<template>
  <q-page class="q-pa-md">
    ...
    <q-card class="modal-add" style="max-width: 800px; width: 100%;">
        ...
        <q-form @submit.prevent="saveProduct">
          ...
          <div class="row q-col-gutter-md">
            ...
            <div class="col-12 col-md-6">
              ...
              <q-select v-model="form.tribute_id" :options="tributeOptions" map-options emit-value label="Tributo" outlined dense lazy-rules :rules="[val => !!val || 'Este campo es requerido']" />
      ...
      <q-table flat bordered :rows="rows" :columns="columns" row-key="id" v-model:pagination="pagination"
